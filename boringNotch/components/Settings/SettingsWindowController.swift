...
class SettingsWindowController: NSWindowController {
    ...
    private func setupWindow() {
        ...
        window.identifier = NSUserInterfaceItemIdentifier("OrbitoSettingsWindow")
        
        // Create the SwiftUI content (NotchNest Settings matching Image 2)
        let settingsView = NotchNestSettingsView()
